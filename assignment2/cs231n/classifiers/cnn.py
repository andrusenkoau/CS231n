...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        l3_dout, grads['W3'], grads['b3'] = affine_backward(dout, l3_cache)
        l2_dout, grads['W2'], grads['b2'] = affine_relu_backward(l3_dout, l2_cache)
        l1_dout, grads['W1'], grads['b1'] = conv_relu_pool_backward(l2_dout, l1_cache)
